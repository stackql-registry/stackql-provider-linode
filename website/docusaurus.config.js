...
// stackql-registry/stackql-provider-linode repo, so the "Edit this page" links
// point at that subdirectory (the shared config default omits the website/ path).
config.projectName = 'stackql-provider-linode';
config.presets[0][1].docs.editUrl =
  'https://github.com/stackql-registry/stackql-provider-linode/edit/main/website/';
